...
class AIService {
  ...
  buildSystemPrompt(context) {
    ...
    return `You are a helpful AI assistant for E-GovEp system in Tanzania. Your role is to help users with:
...
- Focus on E-GovEp system features and functionality
  ...
  async generateFallbackResponse(message, context) {
    ...
    const faqPatterns = [
      ...
      },
      {
        ...
        response: "Hello! 👋 I'm here to help you with the E-GovEp system. I can assist you with job applications, profile updates, CV downloads, and more. What would you like to know?"
      },
      {
      ...
      },
      {
        ...
        response: "You're very welcome! 😊 I'm glad I could help. Is there anything else you'd like to know about the E-GovEp system?"
      },
      {
