  ...
  const renderSkillsTab = () => (
    <div className="space-y-6">
      ...
      <div className="text-center py-8">
        ...
        <h3 className="text-lg font-semibold text-gray-600 mb-2">Forecasting Service Disabled</h3>
        <p className="text-sm text-gray-500 mb-4 max-w-md mx-auto">
          Employment trend forecasting has been disabled. Please use Market Insights for real market data analysis.
        </p>
        <button
